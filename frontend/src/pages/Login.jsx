...
export default function Login() {
  ...
  return (
    <div className="mx-auto flex max-w-md flex-col px-5 py-20">
      <p className="label text-orient-deep">Welcome back</p>
      <h1 className="mt-4 font-display text-4xl tracking-tight" style={{ fontWeight: 460 }}>Enter the field.</h1>
      <p className="mt-3 text-sm text-ink-soft">Sign in to {brand?.name} to join circles and follow your connections.</p>
